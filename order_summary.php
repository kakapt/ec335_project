...
<body class="bg-black text-white">
    <header class="bg-black shadow-lg sticky top-0 z-50 py-4">
        <div class="container mx-auto px-4 flex items-center justify-between">
            ...
            <ul class="hidden md:flex space-x-8">
                ...
                <li><a href="order_summary.php" class="text-primary font-medium">Order Summary</a></li>
            </ul>
    ...
    <section class="py-16 px-4">
        <div class="container mx-auto max-w-md text-center">
            <h1 class="text-4xl font-bold mb-8">Generate <span class="text-primary">Order Summary</span></h1>

            <form action="order.php" method="GET" class="flex flex-col items-center gap-6 bg-black border border-gray-800 p-8 rounded-lg shadow-lg">
                <div class="w-full">
                    <label for="order_id" class="block text-lg font-semibold text-gray-300 mb-2">Enter Order ID:</label>
                    <input type="text" id="order_id" name="order_id" placeholder="e.g., 12345"
                           class="w-full px-4 py-3 bg-black border border-gray-700 rounded-lg focus:outline-none focus:ring-2 focus-ring-offset-0 focus:ring-primary text-white placeholder-gray-500">
                </div>

                <button type="submit"
                        class="w-full bg-primary hover:bg-primary-dark text-white font-bold py-3 px-6 rounded-lg transition duration-300 text-lg">
                    Generate Summary
                </button>
            </form>
        </div>
